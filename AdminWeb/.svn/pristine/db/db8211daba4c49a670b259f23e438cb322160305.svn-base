						...
						minimize : function() {
							...
							c
									.wrap('<div class="jqx-menu-wrapper" style="z-index:'
											+ this.popupZIndex
											+ '; padding: 0px; display: none; margin: 5px 0px 0px -5px; height: 635px; width: auto; position: absolute; top: 0; left: 0; display: block; visibility: visible; overflow-x: hidden; overflow-y: auto;"></div>');
