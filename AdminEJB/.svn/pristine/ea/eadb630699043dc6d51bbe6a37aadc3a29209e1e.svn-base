...
public class CheckFreeFormGeo {
	...
	public void manageAlert(List<Vehicleevent> vehicleevents1, Vehicle vehicle,
		...
		/*
		 * LOGGER.error("Check FreefomAlert prevHMap Vin: " + plateNo +
		 * " prevHMap: " + prevHMap);
		 */
		if (prevHMap.isEmpty()) {
			return;
		...
		for (; i < dates.size(); i++) {
			...
			/*LOGGER.error("Check FreefomAlert currHMap Vin: " + plateNo
					+ " currHMap: " + currHMap);
			LOGGER.error("Check FreefomAlert currHMap Vin: " + plateNo
					+ " currHMap: " + currHMap + " prevHMap: " + prevHMap
					+ " currVE:" + currVE + " timeZoneMode: " + timeZone + " "
					+ mode);*/
