...
public class ItracDeviceHandler2 extends DeviceHandler {
	...
	protected void handleDevice() {
		LOGGER.info("Entered ItracAdvanced five mins Handle Device:"
				+ new Date());
		...
		try {
			...
			ListenerStarter.itracDeviceHandlerMap2.put(deviceImei, this);
