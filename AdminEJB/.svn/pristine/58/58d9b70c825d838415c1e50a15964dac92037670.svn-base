...
public class CheckFuelLevel {
	...
	private static final String STR_FUEL_LEVEL = "Fuel Level";
	Date lastUpdatedTime;

	public CheckFuelLevel(AlertsManager alertsManager1) {
			...
			if ((true) && (io > 0)) {
				...
				if (ioVE != 0) {
					if ((ioVE < min) && (isMin)) {
						...
						String description = "Alert%0DType:Fuel Low Level%0Dvehicle:"
								+ plateNo
								+ "%0DValue:"
								+ (int) ioVE
								+ "L%0DRange:"
						...
						va.setAlerttype(STR_FUEL_LEVEL);
						...
						String eventTime = TimeZoneUtil.getStrTZDateTime(ve
								.getId().getEventTimeStamp());
						String description = "Alert%0DType:Fuel High Level%0Dvehicle:"
								+ plateNo
								+ "%0DValue:"
								+ (int) ioVE
								+ "L%0DRange:"
