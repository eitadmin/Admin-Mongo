	...
	public void unwrapDataFromStream() throws IOException {
		try {
			...
			if (this.deviceData.length <= 1
					|| this.deviceData[1].equalsIgnoreCase("$LGN")) {
				LOGGER.error("-----------Ais140V3 Login Data  -------- ");
				...
				dos.write(responce.getBytes());
					...
					|| this.deviceData[4].equalsIgnoreCase("BR")
					|| this.deviceData[4].equalsIgnoreCase("BD")
					|| this.deviceData[4].equalsIgnoreCase("RT")
					|| this.deviceData[4].equalsIgnoreCase("TA")
					|| this.deviceData[4].equalsIgnoreCase("HA")
					|| this.deviceData[4].equalsIgnoreCase("HB")
					|| this.deviceData[4].equalsIgnoreCase("HP")) {
				...
				this.ais140GpsDataV3.reademr(this.deviceData);
					...
					|| deviceData[1].equalsIgnoreCase("$HLT")) {
				this.imei = this.deviceData[4];
