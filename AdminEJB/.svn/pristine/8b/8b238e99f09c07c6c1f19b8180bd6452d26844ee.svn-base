...
import com.eiw.alerts.CheckEventAlert;
...
public class AlertDetails {
	...
	private CheckEventAlert checkEventAlert = null;
	...
	public void addEventAlert(Alertconfig alertconfig, Date lastUpdatedTime) {
		checkEventAlert = new CheckEventAlert(alertconfig, lastUpdatedTime);
		map.put(alertconfig.getId().getAlertType(), checkEventAlert);
	}
}
