...
public class CheckLowBattery implements CheckAlerts {
	AlertsEJBRemote alertsEJBRemote = null;
	AlertsManager alertsManager;
	Alertconfig alertConfig = null;
	Date lastUpdatedTime;

	public CheckLowBattery(AlertsManager alertsManager1) {
		alertsManager = alertsManager1;
		alertsEJBRemote = alertsManager.alertsEJBRemote;
	}

	public CheckLowBattery(Alertconfig alertConfig, Date lastUpdatedTime) {
	...
	public void manageAlert(List<Vehicleevent> vehicleevents,
		...
		AlertsEJB.LOGGER.debug("Inside CheckLowBattery Alert ->");
			...
			if (vehi.getIoevent() != null) {
				...
				for (int i = 0; i < ioevent.length; i++) {
					...
					if (ioSource[0].equalsIgnoreCase("600")) {
						...
						if (io.equalsIgnoreCase("LowBattery")) {
							String mobile2 = null;
							...
							for (Vehicleevent ve : vehicleevents) {
								...
								if (!address
									...
									description = "LowBattery%0DVehicle:" + plateNo
											+ "%0D%0DTime:" + eventTime
