...
public class ModbusDataTest {
	...
	public void read(String[] deviceData) {
		...
		String dateTime = "";
		if (date.length() == 7) {
			dateTime = date.substring(3, 7) + "-" + date.substring(1, 3) + "-0"
		...
		this.gpsAltitude = deviceData[15];
		this.noOfSatlite = deviceData[16];
		...
		// String modBusData = deviceData[12].substring(deviceData[12]
		// .toUpperCase().indexOf("0A03"));
