...
import com.eiw.device.deepsea.ModbusData;
import com.eiw.device.handler.DeepSeaDeviceHandler;

public class DeepSeaByteWrapperV1 {
	...
	private ModbusDataV1 modbusData = new ModbusDataV1();

	public DeepSeaByteWrapperV1(DataInputStream in) {
		this.dis = in;
	}
	...
	public ModbusDataV1 getmodbusData() {
		return modbusData;
	}

	public void setmodbusData(ModbusDataV1 modbusData) {
