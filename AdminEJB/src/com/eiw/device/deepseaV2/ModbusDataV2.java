...
public class ModbusDataV2 {
	...
	private String internalBatVolt;
	...
	public String getMainInputVoltage() {
		return mainInputVoltage;
	}

	public void setMainInputVoltage(String mainInputVoltage) {
		this.mainInputVoltage = mainInputVoltage;
	}

	public String getInternalBatVolt() {
		return internalBatVolt;
	}

	public void setInternalBatVolt(String internalBatVolt) {
		this.internalBatVolt = internalBatVolt;
	}
	...
	public void read(String[] deviceData) {
		if (deviceData[0].equalsIgnoreCase("<3")) {
			this.dataType = "logIn";
			String dateTime = dateTime(deviceData[6], deviceData[7]);
			...
			this.lattitude = deviceData[9];
			this.latDir = deviceData[10];
			this.longitude = deviceData[11];
			this.longDir = deviceData[12];
			this.speed = Double.valueOf(deviceData[13]).intValue();
			this.headDegree = deviceData[14];
			this.noOfSatlite = deviceData[15];
			this.gpsAltitude = deviceData[16];
			this.operator = deviceData[17];
			this.gsmSignal = deviceData[18];
			this.mainPower = deviceData[19];
			this.mainInputVoltage = deviceData[20];
			this.internalBatVolt = deviceData[21];

			this.DIP1 = deviceData[22].split("")[0];
			this.DIP2 = deviceData[22].split("")[1];
			this.DOP1 = deviceData[23].split("")[0];
			this.DOP2 = deviceData[23].split("")[1];

			this.AIP1 = deviceData[24];
			this.AIP2 = deviceData[25];
			this.AIP3 = deviceData[26];
			this.AIP4 = deviceData[27];
			this.onWire = deviceData[28];
		} else if (deviceData[0].contains("CONFIG")) {
			this.ackref = Integer.parseInt(deviceData[4].split("")[0]);
		} else {
			this.dataType = "modBus";
			String[] modDaata = deviceData;
			for (int i = 0; i < modDaata.length - 1; i++) {
				String[] rawData = modbusSplit(modDaata[i]);
				if (i == 0) {
					String dateTime = dateTime(rawData[3], rawData[4]);
					try {
						this.dateTime = sdfTime.parse(dateTime);
					} catch (ParseException e1) {
						// TODO Auto-generated catch block
					...
					modbusRead(rawData[3], rawData[1]);
				}
			}
		}
	}
	...
	public String[] modbusSplit(String modbus) {
		return modbus.split(",");
	}

	public void modbusRead(String modbus, String reqId) {

		this.requestId = hex2decimal(reqId);
		System.out.println("requestId: " + requestId);

		String modBusData = modbus;
		if (!modBusData.equalsIgnoreCase(";")) {
			...
			try {
				...
				case 1:
					...
					/*
					 * } else { this.genL2W="0.00"; this.genL1_N_V = "00.0";
					 * this.genL2_N_V = "00.0"; this.genL3_N_V = "0.00";
					 * this.genL1_L2_V = "00.0"; this.genL2_L3_V = "0.00";
					 * this.genL3_L1_V = "0.00"; this.genL1C = "0.00";
					 * this.genL2C = "0.00"; this.genL3C = "00.0";
					 * this.genEarthC = "00.0"; this.genL1W = "00.0";
					 * this.genL2W = "00.0"; this.genL3W = "00.0"; this.genC_lag
					 * = "00.0"; this.mainsFrequency = "00.0"; this.mainsL1_N_V
					 * = "00.0"; this.mainsL2_N_V = "00.0"; this.mainsL3_N_V =
					 * "00.0";
					 * 
					 ...
					 * 
					 * this.mainsV_lag = "00.0"; this.gen_P_R = "00.0";
					 * this.mains_P_R = "00.0"; this.mainsC_lag = "00.0";
					 * 
					 * this.mainsL1C = "00.0";
					 * 
					 * this.mainsL2C = "00.0"; this.mainsL3C = "00.0";
					 * 
					 * this.mainsEarthC = "00.0";
					 * 
					 * this.mainsL1W = "00.0"; this.mainsL2W = "00.0";
					 * this.mainsL3W = "00.0"; }
					 */
				...
				case 3:
					 ...
					 * } else {
					 * 
					 * this.gentotVA = "00.0"; this.genL1VAr = "00.0";
					 * this.genL2VAr = "00.0"; this.genL3VAr = "00.0";
					 * this.gentotVAr = "00.0"; this.genPFL1 = "00.0";
					 * this.genPFL2 = "00.0"; this.genPFL3 = "00.0";
					 * this.genPFAvg = "00.0"; this.genFullPower = "00.0";
					 * this.genFullVAr = "00.0"; this.mains_tot_W = "00.0";
					 * this.mainsL1VA = "00.0"; this.mainsL2VA = "00.0";
					 * this.mainsL3VA = "00.0"; this.mainstotVA = "00.0";
					 * this.mainsL1VAr = "00.0"; this.mainsL2VAr = "00.0";
					 * this.mainsL3VAr = "00.0"; this.mainstotVAr = "00.0";
					 * this.mainsPFL1 = "00.0"; this.mainsPFL2 = "00.0";
					 * this.mainsPFL3 = "00.0"; this.mainsPFAvg = "00.0"; }
					 */
				...
				case 4:
					...
					/*
					 * } else { this.genL1lag = "00.0"; this.genL2lag = "00.0";
					 * this.genL3lag = "00.0"; this.gentotlag = "00.0";
					 * this.genL1FullPower = "00.0"; this.genL2FullPower =
					 * "00.0";
					 * 
				...
				case 5:
					 ...
					 * } else {
					 * 
					 * this.genPositiveKWH = "00.0"; this.genNegativeKWH =
					 * "00.0"; this.genKVAH = "00.0";
					 * 
					 * this.genKVArH = "00.0"; this.numberOfStart = "00.0";
					 * this.mainsPositiveKWH = "00.0"; this.mainsNegativeKWH =
					 * "00.0"; this.mainsKVAH = "00.0"; this.mainsKVArH =
					 * "00.0"; this.busPositiveKWH = "00.0";
					 * 
					 * this.busKVAH = "00.0"; this.busKVArH = "00.0";
					 * this.fuelUsed = "00.0"; this.maxPositiveMains_ROCOF =
					 * "00.0"; this.maxNegativeMains_ROCOF = "00.0";
