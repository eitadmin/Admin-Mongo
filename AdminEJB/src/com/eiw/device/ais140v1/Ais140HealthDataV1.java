...
public class Ais140HealthDataV1 {
	...
	public void read(String[] deviceData) {
		...
		this.vendorId = deviceData[1];
		this.fwVersion = deviceData[2];
		this.batteryPercent = Integer.parseInt(deviceData[4]);
		this.lowBatteryThreshold = Integer.parseInt(deviceData[5]);
		this.memoryPercent1 = Float.valueOf(deviceData[6]);
		this.memoryPercent2 = Float.valueOf(deviceData[7]);
		this.ignitionONInterval = deviceData[8];
		this.ignitionOFFInterval = deviceData[9];
		this.ai1 = Float.valueOf(deviceData[11]);
		String analogInput2 = deviceData[12].split("\\*")[0];
		this.ai2 = Float.valueOf(analogInput2);
