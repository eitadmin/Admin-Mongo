...
public class ListenerStarter {
	...
	public static Map<String, DeepSeaDeviceHandlerTest> deepseaTestMap = new HashMap<String, DeepSeaDeviceHandlerTest>();
	public static Map<String, DeepseaDeviceHandler_V1> deepseaDeviceV1Map = new HashMap<String, DeepseaDeviceHandler_V1>();
	public static Map<String, APMKT_AIS1401ADeviceHandler> apmkt_AIS1401ADeviceHandlerMap = new HashMap<String, APMKT_AIS1401ADeviceHandler>();
	public static Map<String, DeepseaDeviceHandlerV2> deepseaDeviceHandlerV2Map = new HashMap<String, DeepseaDeviceHandlerV2>();

	static final Devices[] DEVICE_TYPES_USED = { Devices.TELTONIKA,
			...
			Devices.CANTRACK, Devices.APMKT_AIS1401A, Devices.DeepseaTest,
			Devices.DeepSeaV1, Devices.DeepSeaV2 };
